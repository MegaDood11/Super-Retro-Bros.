...
local zoomedBuffer = Graphics.CaptureBuffer(512,448)
...
do
    ...
    local backgroundBuffer = Graphics.CaptureBuffer(512,448)
...
function customCamera.onCameraUpdate()
    ...
    -- wait for the camera to adjust to new screen size
